...
class Piece:
    ...
    def __init__(self, x, y, team, hp, mana, agility, defense, damage):  # init method for evety piece where it gets another ingame values assigned
        self.max_hp = hp
        self.max_mana = mana
        self.team = team
        self.grid_pos_x = x
...
class Mage(Piece):
    ...
    def __init__(self, x, y, team, hp, mana, agility, defense, damage):
        
        super().__init__(x, y, team, hp, mana, agility, defense, damage)
